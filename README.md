...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xmldiff-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11877&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xmldiff-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xmldiff` can be installed with:

```
conda install xmldiff
```

It is possible to list all of the versions of `xmldiff` available on your platform with:
